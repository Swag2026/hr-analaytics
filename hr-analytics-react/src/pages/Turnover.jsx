    ...
    <>
      <div className="card mb-24" style={{ borderRight: '3px solid var(--warning)', background: 'var(--warning-bg)' }}>
        <div className="flex items-center gap-12">
          ...
          <div>
            <div style={{ fontWeight: 800, color: 'var(--brass-dark)' }}>ملاحظة دقة البيانات</div>
            <div className="small" style={{ color: 'var(--brass-dark)' }}>
              أرقام "المغادرات" في هذه الصفحة مستخرجة من ملاحظات "متغيرات الشهر" النصية داخل ملفات الإكسل، وهي سجلات تراكمية غير موحدة الصياغة بين الأشهر. اعتبرها تقديرًا أوليًا فقط إلى أن يتم اعتمادها من الموارد البشرية — راجع{' '}
              <a href="#/correction-log" style={{ color: 'var(--brass-dark)', fontWeight: 700 }}>سجل التعديلات</a> لتفاصيل المعالجة.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="kpi-grid mb-24">
        <div className="kpi-card"><div className="label">إجمالي المغادرات (تقديري) <Icon name="info" size={12} /></div><div className="value">{fmtNum(totalExits)}</div></div>
        <div className="kpi-card"><div className="label">إجمالي التعيينات الجديدة (تقديري)</div><div className="value">{fmtNum(totalHires)}</div></div>
        <div className="kpi-card"><div className="label">معدل الدوران التقريبي</div><div className="value">{turnoverRate}<span className="unit">%</span></div></div>
        <div className="kpi-card"><div className="label">صافي التغيير في القوى العاملة</div><div className="value">{fmtNum(totalHires - totalExits)}</div></div>
      </div>

      <div className="grid-2 mb-24">
        <div className="card">
          <div className="section-head"><h2>الدوران حسب الشركة (تقديري تراكمي)</h2></div>
        ...
        <div className="card">
          <div className="section-head"><h2>اتجاه عدد الموظفين الشهري (مؤشر غير مباشر على الاستقرار)</h2></div>
          <LineChart
      ...
      <div className="card">
        <div className="section-head"><h2>تفصيل حسب الشركة</h2></div>
